  ...
  <div>
    ...
    <el-card class="box-card2">
      ...
      >
        ...
        <el-table-column align="right" width="100" label="删帖">
          <template #default="scope">
            <el-button
              size="mini"
              type="danger"
...
export default {
  ...
  computed: {
    tableData() {
      ...
      let list = this.tableData.filter(
        (data) =>
          !search ||
          data.postname.toLowerCase().includes(search.toLowerCase()) ||
          data.postname.toLowerCase().includes(search.toLowerCase())
      );
      return list;
    },
  ...
  methods: {
    ...
    showchangeConfirmDialog(index, row) {
      ...
      ElMessageBox.prompt("请输入修改您的帖子", "帖子修改", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        message:row.postname,
