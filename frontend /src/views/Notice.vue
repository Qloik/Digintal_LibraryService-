    ...
    <el-container class="home-container">
        <el-main>
            <div class="content">
                ...
                <span style="line-height:35px; white-space: pre-wrap">
                    {{ text.replace(/\\n/g,"\n") }}
                </span>
            </div>
...
export default {
  ...
  methods: {
    ...
    mounted() {
        console.log(this.$route.query.title, 7777);
        // axios({
        //     method: 'post',
        ...
        // })
        this.$data.text = this.$route.query.text
...
.el-main {
    //background: #d3dce6;
    background-image: url("../assets/notice-bg.jpg");
